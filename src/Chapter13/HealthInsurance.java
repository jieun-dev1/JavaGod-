...
public enum HealthInsurance {
	LEVEL_ONE(1000, 1.0), LEVEL_TWO(2000, 2.0), LEVEL_THREE(3000, 3.2), LEVEL_FOUR(4000, 4.5), LEVEL_FIVE(5000, 5.6),
	LEVEL_SIX(6000, 7.1);
	...
	public static void main(String[] args) {
		int[] salaryArray = new int[] { 1500, 5500, 8000 };// SalaryArray라는 열에 연봉 더미를 넣어줌.
